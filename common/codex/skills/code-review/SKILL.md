...
Prioritize high-risk defects first and return findings in a strict, actionable format.
...
- Include location, impact rationale, and concrete fix suggestion for each finding.
